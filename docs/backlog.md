...
### ~~A5 · [窄残留] #9 evidence-only COMPLETED 的 duration 缺失~~ —— ✅ 已交付(2026-07-11,a5c5d53)
...
### ~~A7 · [文档] freeswitch/local/README.md 密码过时~~ —— ✅ 已交付(2026-07-11,fdd0843)
...
### ~~A8 · [小 UX 债] 首页已发布流程下拉边界~~ —— ✅ 已交付(2026-07-11,fdd0843)
...
### ~~B-P1a · [P1] FunASR 服务端 fsmn-vad 可配置关闭~~ —— ✅ 已交付(2026-07-11,FUNASR_SERVER_VAD_ENABLED 默认开,关闭走 fallback 路径+不加载模型)
...
### ~~B-P1b · [P1] 语义自适应端点检测~~ —— ✅ 已交付(2026-07-11,partial 结尾数字+600ms/犹豫词+400ms/上限1600ms,VAD_SEMANTIC_ENDPOINT_ENABLED 默认开)
...
### ~~D8 · [建议] API 补真正的健康检查端点~~ —— ✅ 已交付(2026-07-11,269ed6a:GET /api/health 含 DB ping)
