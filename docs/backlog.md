...
### A4 · [窄残留] #1 originate 幂等的 bgapi 异步崩溃窗口 —— 🔄 进行中(2026-07-11)
...
- **优先级**:低(概率极低,但属外呼合规)→ 已提升为上线前项,实施中。
...
### A6 · [运维] 死信 sink 指向持久卷 —— 🔄 进行中(2026-07-11)
